...
public class Books {
	...
	public Books(int book_id, String book_name, String book_authors, Double book_price, String book_dept,
			Date book_published, Date book_date_of_barrow, Date book_date_of_return, boolean is_book_available) {
		super();
	...
	public String toString() {
		return "Books [book_id=" + book_id + ", book_name=" + book_name + ", book_authors=" + book_authors
				+ ", book_price=" + book_price + ", book_dept=" + book_dept + ", book_published=" + book_published
				+ ", book_date_of_barrow=" + book_date_of_barrow + ", book_date_of_return=" + book_date_of_return
	 ...
	 @Override
	    public boolean equals(Object o) {
	        ...
	        if (book_id != book.book_id) return false;
	        return book_name.equals(book.book_name);
